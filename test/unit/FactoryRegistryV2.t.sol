...
contract FactoryRegistryV2Test is Test {
    ...
    function test_CreateMultipleProxies() public {
        ...
        assertEq(registry.indexOfProxy(address(registry.proxyAddressOfOwnerByIndex(user, 0))), 0);
        assertEq(registry.indexOfProxy(address(registry.proxyAddressOfOwnerByIndex(user, 1))), 1);
    }
